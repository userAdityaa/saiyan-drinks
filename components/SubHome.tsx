...
const SubHome = () => {
  ...
  return (
    <div className={`${oswald.className} relative`}>
      <svg xmlns="http://www.w3.org/2000/svg" className='-mt-[12rem]' xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 375 86" width="375" height="86" preserveAspectRatio="xMidYMid meet" style={{ width: '100%', height: '100%', transform: 'translate3d(0px, 0px, 0px)', contentVisibility: 'visible' }}>
      <defs>
    ...
    <div className='bg-[#f0e14a] h-[160vh] flex flex-col items-center font-bold text-[#fc0c68]'>
      ...
      <Image src='/lemonMain.webp' alt='lemon main' height={0} width={120} className='absolute top-[50rem] left-[15rem]' ref={leftLimeRef}></Image>
      ...
      <Image src='/limeFlav.webp' alt='lemon main' height={0} width={300} className='absolute top-[63rem] left-[18rem]'></Image>
      <Image src='/lemonBagMain.webp' alt='lemon main' height={0} width={640} className='absolute top-[57rem] right-[0rem]'></Image>
    </div>
    </div>
  )
}
