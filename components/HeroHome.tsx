...
const HeroHome = () => {
  return (
    <div className={`bg-[#4eceff] h-[180vh] max-mini:h-[210vh] w-[100vw] ${oswald.className} flex flex-col justify-center items-center`}>
        ...
        <p className='text-white w-[30%] text-center -mt-[60vh] max-mini:-mt-[80rem] max-pad:-mt-[94rem] max-air:-mt-[85rem] max-sm:w-[95%] max-sm:-mt-[74rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex quisquam beatae sit doloribus atque</p>
        <button className='bg-[#fff500] text-[#4eceff] py-[0.8rem] px-[1.4rem] rounded-md font-bold text-[20px] mt-[1.5rem]'>SHOP NOW</button>
        <Image src='/mainCan.webp' alt='main can' width={2300} height={0} className='absolute top-[75%] left-[12%] max-pad:top-[40%] max-mini:w-[88%] max-mini:top-[55%] max-sm:w-[4000px]'></Image>
