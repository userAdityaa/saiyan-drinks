...
const HeroHome = () => {
  return (
    <div className={`bg-[#4eceff] h-[180vh] max-mini:h-[210vh] w-[100vw] ${oswald.className} flex flex-col justify-center items-center`}>
        <Image src='/goSaiyan.webp' width={1100} height={500} alt='logo' className='absolute top-[22%] left-[18vw] w-[64%] max-pad:top-[13%] max-mini:top-[18%]'></Image>
        <p className='text-white w-[30%] text-center -mt-[60vh] max-mini:-mt-[80rem] max-pad:-mt-[94rem] max-air:-mt-[85rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex quisquam beatae sit doloribus atque</p>
        <button className='bg-[#fff500] text-[#4eceff] py-[0.8rem] px-[1.4rem] rounded-md font-bold text-[20px] mt-[1.5rem]'>SHOP NOW</button>
        <Image src='/mainCan.webp' alt='main can' width={1200} height={300} className='absolute top-[75%] left-[12%] max-pad:top-[40%] max-mini:w-[88%] max-mini:top-[55%]'></Image>
