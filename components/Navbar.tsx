...
import { navbarCan, navbarCanName, navbarCanBackground, oswald, defaultTheme, themeConfigs } from '@/constants';
...
const Container = () => {
    ...
    const activeTheme = search ? themeConfigs.find(config => config.themeName === theme) || defaultTheme : defaultTheme;
        ...
        <nav className={`fixed border rounded-full w-[80vw] h-[9vh] top-5 left-[10vw] flex items-center ${oswald.className} text-[20px] font-semibold ${activeTheme.mainthemeStyle} bg-white z-50 max-pad:h-[5vh] max-pad:w-[95vw] max-pad:left-[2.2vw] max-mini:h-[8vh] max-mini:w-[95vw]`}>
            ...
            <div className='flex items-center mr-[12vw] max-mini:hidden max-air:hidden'>
                <div className='flex items-center mr-4 ml-[35px]' onClick={handleProductClick}>
                    ...
                    <svg width="34" height="34" viewBox="0 0 24 24" fill={activeTheme.svgFillColor} xmlns="http://www.w3.org/2000/svg">
