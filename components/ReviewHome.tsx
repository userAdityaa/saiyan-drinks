...
const ReviewHome = () => {
  ...
  return (
    <div className={`bg-[#f13e36] mt-[58rem] h-[120vh] z-[100] text-white ${oswald.className} max-pad:h-[80vh] max-air:mt-[70rem] max-mini:h-[150vh] max-mini:mt-[85rem]`}>
        <div className='flex flex-col items-center h-[90%] max-mini:-mt-[2rem] z-50 '>
            ...
            <div className='flex space-x-[1rem] mt-[5rem] w-[90%] max-air:flex-wrap max:mini:flex-wrap'>
                {containerImage.map((container, index) => { 
                    return <div className='max-air:w-[22.5rem] w-[32rem] h-[25rem] rounded-lg bg-red-100 bg-opacity-45 flex flex-col items-center max-air:last:w-[60rem] max-air:last:h-[18rem] max-air:last:mt-[8rem] max-mini:w-[21rem] max-mini:last:w-[90rem]'>
